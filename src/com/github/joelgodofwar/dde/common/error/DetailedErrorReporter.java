...
import com.github.joelgodofwar.dde.common.collections.ExpireHashMap;
import com.github.joelgodofwar.dde.common.error.Report.ReportBuilder;
...
public class DetailedErrorReporter implements ErrorReporter {
	...
	public DetailedErrorReporter(Plugin plugin, String prefix, String supportURL, int maxErrorCount, Logger logger) {
		...
		this.logger = logger;
		this.dde = (DragonDropElytra) plugin;
	}
	...
	public void reportDetailed(Object sender, Report report) {
		...
		// And plugin
		if (plugin != null) {
			writer.println("Version: " + dde.getName() + " v" + dde.getDescription().getVersion());
			String jarfilename = dde.getjarfilename();
		...
		FileConfiguration config = dde.getConfig();
