...
/**
 * Custom logger for the DragonDropElytra plugin.
 */
public class PluginLogger {
	 ...
	 */
	public PluginLogger(DragonDropElytra plugin) {
	...
	public void log(Level level, String message, Object... args) {
		...
		message = ChatColor.RESET + "[" + ChatColor.YELLOW + dde.getName() + ChatColor.RESET + "] " + message;
		if(!dde.colorful_console) {
